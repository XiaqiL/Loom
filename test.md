...
1. **Revenue Detection**  
   Collects the latest shop or product financial metrics from the user and maintains a structured revenue dataset in `revenue_detection.csv`.
...
Agent 02 takes the following files generated by Agent 01 as upstream inputs:
...
Agent 02 functions as the operational intelligence layer of the system.
It bridges user-provided business data and external market research to support:
